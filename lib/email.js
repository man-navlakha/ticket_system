...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="color: #cccccc; line-height: 1.6;">
                You&apos;ve been invited to join Man&apos;s Support Desk as a <span class="role-badge">${role}</span>.
            </p>
            <p style="color: #cccccc; line-height: 1.6;">
    ...
    const emailText = `
You&apos;ve been invited to join Man&apos;s Support Desk
...
If you didn't expect this invitation, please ignore this email.
    ...
    const mailOptions = {
        ...
        to: toEmail,
        subject: `🎟️ You've been invited to Man's Support Desk`,
        text: emailText,
        html: emailHtml,
    };
