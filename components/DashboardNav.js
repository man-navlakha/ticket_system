        ...
        <>
            ...
            <nav data-print-hide className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0a0a0a] border-t border-white/10 pb-safe">
                <div className="flex items-center justify-around h-16 px-2 relative">
                    ...
                    {/* Home */}
                    <Link data-tour="mobile-home" href="/dashboard" className={`flex flex-col items-center justify-center w-14 h-full space-y-1 ${isActive('/dashboard') ? 'text-white' : 'text-gray-500'}`}>
                    ...
                    {/* Inventory */}
                    <Link data-tour="mobile-inventory" href="/dashboard/inventory" className={`flex flex-col items-center justify-center w-14 h-full space-y-1 ${isActive('/dashboard/inventory') ? 'text-white' : 'text-gray-500'}`}>
                        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {/* Create Action (FAB) */}
                    <Link data-tour="mobile-create-fab" href="/dashboard/create" className="flex items-center justify-center -mt-8">
