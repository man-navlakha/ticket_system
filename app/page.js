              ...
              <div className="relative group">
                ...
                <div className="relative flex items-center bg-background rounded-lg border border-border p-1">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-2 bg-primary text-primary-foreground rounded text-sm font-semibold hover:opacity-90 transition-colors disabled:opacity-50"
                  >
          ...
          <div className="max-w-md mx-auto">
            ...
            <form onSubmit={handleRequestAccess} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 bg-primary text-primary-foreground font-medium rounded-lg hover:opacity-90 transition-colors text-sm disabled:opacity-50"
              >
